...
function AppReact() {
    ...
    function onChangeVolume({target}){
      ...
      document.getElementsByTagName("audio").volume=valueVolume/100;
    }
    return ( <div className={App.drumMachine}>
      <div className={cx("drum-display")} ref={refInput}>
         
      </div>
      <div className={cx("drum-control")}>
      <div className={cx("drum-control-volum")}>
          <span>Volume</span>
        <input type="range" className='volume' onInput={onChangeVolume} value={volume}></input>
         </div>
